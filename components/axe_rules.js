const RuleInfo = {
  ...
  "duplicate-id-active": {
    ...
    helpUrl:
      "https://dequeuniversity.com/rules/axe/4.6/duplicate-id-active?application=axeAPI",
  ...
  "duplicate-id-aria": {
    ...
    helpUrl:
      "https://dequeuniversity.com/rules/axe/4.6/duplicate-id-aria?application=axeAPI",
    tags: ["cat.parsing", "wcag2a", "wcag411"],
    actIds: ["3ea0c8"],
  },
  "duplicate-id": {
